...
//    }
//
//    public static String printCoverageIssueMarkdown(String stashProject, String stashRepo, String pullRequestId, String stashURL,
//            CoverageIssue issue) {
...
//
//    public static String printIssueNumberBySeverityMarkdown(SonarIssuesReport report, CoverageIssuesReport coverageReport, String severity) {
//        StringBuilder sb = new StringBuilder();
...
//    }
//
//    public static String printIssueListBySeverityMarkdown(SonarIssuesReport report, String sonarQubeURL, String severity) {
//        StringBuilder sb = new StringBuilder();
//
...
//    }
//
//    public static String printReportMarkdown(PullRequestRef pr, String stashURL, String sonarQubeURL, SonarIssuesReport report,
//            CoverageIssuesReport coverageReport, int issueThreshold) {
//
//        StringBuilder sb = new StringBuilder("## SonarQube analysis Overview");
//        sb.append(NEW_LINE);
//
//        String stashProject = pr.getProject();
//        String stashRepo = pr.getRepository();
//        int pullRequestId = pr.getId();
//
...
//    }
//
//    public static String printCoverageReportMarkdown(String stashProject, String stashRepo, int pullRequestId, CoverageIssuesReport coverageReport,
//            String stashURL) {
...
//
//        sb.append(projectCoverage).append("% (").append((diffProjectCoverage > 0) ? "+" : "").append(diffProjectCoverage).append("%)").append(" |")
//          .append(NEW_LINE);
//        sb.append("|---------------|").append(NEW_LINE);
//
...
////                sb.append("| ")
////                  .append(MarkdownPrinter.printCoverageIssueMarkdown(stashProject, stashRepo, String.valueOf(pullRequestId), stashURL, coverageIssue))
